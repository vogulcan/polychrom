...
def gene_aware_topology(
    ...
    *,
    ...
    rnapii_stride: int = 1,
    rnapii_termination_step_prob: float = 1.0,
    ...
    rnapii_pause_term_prob: float = 0.0,
    ...
    args["rnapii_termination_step_prob"] = float(rnapii_termination_step_prob)
    ...
    args["rnapii_pause_term_prob"] = float(rnapii_pause_term_prob)
